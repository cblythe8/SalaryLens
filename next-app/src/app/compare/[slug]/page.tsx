    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
        <div className="bg-white rounded-lg border border-gray-200 p-4 text-center">
          <p className="text-sm text-gray-600 mb-1">{cityAInfo.name} Avg Median</p>
          <p className="text-2xl font-bold text-blue-600">
            {formatSalary(avgA, currencyA)}
          </p>
        </div>
        <div className="bg-white rounded-lg border border-gray-200 p-4 text-center">
          <p className="text-sm text-gray-600 mb-1">Higher Pay Wins</p>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 text-center">
          <p className="text-sm text-gray-600 mb-1">{cityBInfo.name} Avg Median</p>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200">
                  <th className="text-left py-3 font-medium text-gray-600">Occupation</th>
                  ...
                  <th className="text-right py-3 font-medium text-gray-600">Difference</th>
                </tr>
              </thead>
              <tbody>
                {comparisons.map((c) => {
      ...
      <div className="mt-8 flex gap-4">
        ...
        >
          ...
          <p className="text-sm text-gray-600">{recordsA.length} occupations</p>
        </Link>
        <Link
        ...
        >
          ...
          <p className="text-sm text-gray-600">{recordsB.length} occupations</p>
        </Link>
      </div>
    </div>
  );
